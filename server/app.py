...
"""
FastAPI application for the Civic Desk Environment.

This module creates an HTTP server that exposes the CivicDeskEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m civic_desk.server.app
    ...
    multiple workers:
        uvicorn civic_desk.server.app:app --workers 4
    """
    import uvicorn
